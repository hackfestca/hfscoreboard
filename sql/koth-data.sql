...
SELECT addRandomFlag('Test 1.3', 3::smallint, 'poc01.hf', 'web', 1::smallint, Null, Null, True, '', '',
                     'echo $FLAG > /root/flag.txt', 'wget http://dathost/test');
SELECT addRandomFlag('Test 2', 5::smallint, 'poc01.hf', 'expl', 2::smallint, Null, Null, True, '', '',
...
SELECT addFlag('nose01', 'FLAG-OIPL9CKSV2DH9X1SAQGQ', 1, '172.28.72.110', 'web',
                    1::smallint, Null, 'Francois Lajeunesse-Robert', False, '', '', '', '');
...
SELECT addFlag('nose04', 'KOTH-NOSEBLEEDING', 5, '172.28.72.110', 'web',
                    1::smallint, Null, 'Francois Lajeunesse-Robert', True, '', '', 
